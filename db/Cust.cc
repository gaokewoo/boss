...
string Cust::insSQL="INSERT INTO CUST(CUST_ID,PARTY_ROLE_ID,CUST_NAME,CUST_TYPE,CUST_LOCATION,IS_VIP,PARENT_ID,CUST_CODE,STATE,EFF_DATE,EXP_DATE)VALUES (:CUST_ID,:PARTY_ROLE_ID,:CUST_NAME,:CUST_TYPE,:CUST_LOCATION,:IS_VIP,:PARENT_ID,:CUST_CODE,:STATE,SYSDATE,SYSDATE+365)";
