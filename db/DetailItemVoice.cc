...
void DetailItemVoice::prepareSQL()
{
    ...
    stmt->setString(49,detail_item_voice.m_deal_time);
    stmt->setString(50,detail_item_voice.m_group_id);
    stmt->setString(51,detail_item_voice.m_product_code);
    stmt->setString(52,detail_item_voice.m_a_number);
    stmt->setString(53,detail_item_voice.m_brand_code);
    stmt->setString(54,detail_item_voice.m_roam_type_query);
    stmt->setString(55,detail_item_voice.m_fee_type_query);
    stmt->setString(56,detail_item_voice.m_dealfile);
    stmt->setString(57,detail_item_voice.m_error_code);
    stmt->setString(58,detail_item_voice.m_favour_fee1);
    stmt->setString(59,detail_item_voice.m_favour_fee2);
    stmt->setString(60,detail_item_voice.m_favour_fee3);
    stmt->setString(61,detail_item_voice.m_favour_flag);
}
