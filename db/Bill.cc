...
void Bill::insertData()
{
    ...
    string insSQL="INSERT INTO BILL"+m_ym+"(BILL_ID,AI_TOTAL_ID,PAYMENT_ID,PAYMENT_METHOD,BILLING_CYCLE_ID,PARTY_ROLE_ID,ACCT_ID,SERV_ID,ACC_NBR,BILL_AMOUNT,LATE_FEE,DERATE_LATE_FEE,BALANCE,LAST_CHANGE,CUR_CHANGE,CREATED_DATE,PAYMENT_DATE,USE_DERATE_BLANCE,INVOICE_ID,STATE,STATE_DATE)VALUES (:BILL_ID,:AI_TOTAL_ID,:PAYMENT_ID,:PAYMENT_METHOD,:BILLING_CYCLE_ID,:PARTY_ROLE_ID,:ACCT_ID,:SERV_ID,:ACC_NBR,:BILL_AMOUNT,:LATE_FEE,:DERATE_LATE_FEE,:BALANCE,:LAST_CHANGE,:CUR_CHANGE,SYSDATE,SYSDATE,:USE_DERATE_BLANCE,:INVOICE_ID,:STATE,SYSDATE)";
    setSQL(insSQL);
    executeUpdate();
}
