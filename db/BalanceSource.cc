...
void BalanceSource::insertData()
{
    ...
    string insSQL="INSERT INTO BALANCE_SOURCE"+sysdate+"(OPER_INCOME_ID,PAYMENT_ID,ACCT_BALANCE_ID,OPER_TYPE,STAFF_ID,OPER_DATE,AMOUNT,CUR_AMOUNT,BALANCE_RELATION_ID,BALANCE_SOURCE_ID,ALLOW_DRAW,INV_OFFER,CUR_STATUS,CUR_STATUS_DATE,STATE_DATE,STATE)VALUES (:OPER_INCOME_ID,:PAYMENT_ID,:ACCT_BALANCE_ID,:OPER_TYPE,:STAFF_ID,SYSDATE,:AMOUNT,:CUR_AMOUNT,:BALANCE_RELATION_ID,:BALANCE_SOURCE_ID,:ALLOW_DRAW,:INV_OFFER,:CUR_STATUS,SYSDATE,SYSDATE,:STATE)";
