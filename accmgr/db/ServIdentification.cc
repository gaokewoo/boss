...
string ServIdentification::insSQL="INSERT INTO SERV_IDENTIFICATION(SERV_ID,AGREEMENT_ID,ACC_NBR,EFF_DATE,EXP_DATE)VALUES (:SERV_ID,:AGREEMENT_ID,:ACC_NBR,SYSDATE,SYSDATE)";
