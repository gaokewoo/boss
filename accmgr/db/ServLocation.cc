...
string ServLocation::insSQL="INSERT INTO SERV_LOCATION(SERV_ID,AGREEMENT_ID,ADDRESS_ID,BUREAU_ID,EXCHANGE_ID,STAT_REGION_ID,EFF_DATE,EXP_DATE)VALUES (:SERV_ID,:AGREEMENT_ID,:ADDRESS_ID,:BUREAU_ID,:EXCHANGE_ID,:STAT_REGION_ID,SYSDATE,SYSDATE)";
