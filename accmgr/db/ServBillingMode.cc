...
string ServBillingMode::insSQL="INSERT INTO SERV_BILLING_MODE(SERV_ID,AGREEMENT_ID,EFF_DATE,EXP_DATE,BILLING_MODE)VALUES (:SERV_ID,:AGREEMENT_ID,SYSDATE,SYSDATE+365,:BILLING_MODE)";
