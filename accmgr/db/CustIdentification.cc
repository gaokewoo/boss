...
string CustIdentification::insSQL="INSERT INTO CUST_IDENTIFICATION(CUST_ID,AGREEMENT_ID,CERTIFICATE_TYPE,CERTIFICATE_NO,EFF_DATE,EXP_DATE,ATTEST_TYPE,ATTEST_PASSWD,SECRECY_LEVEL)VALUES (:CUST_ID,:AGREEMENT_ID,:CERTIFICATE_TYPE,:CERTIFICATE_NO,SYSDATE,SYSDATE,:ATTEST_TYPE,:ATTEST_PASSWD,:SECRECY_LEVEL)";
