...
string ServStateAttr::insSQL="INSERT INTO SERV_STATE_ATTR(SERV_ID,BILLING_CYCLE_TYPE_ID,AGREEMENT_ID,OWE_BUSINESS_TYPE_ID,STATE,EFF_DATE,EXP_DATE)VALUES (:SERV_ID,:BILLING_CYCLE_TYPE_ID,:AGREEMENT_ID,:OWE_BUSINESS_TYPE_ID,:STATE,SYSDATE,SYSDATE+365)";
