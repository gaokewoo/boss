...
string BalancePayout::insSQL="INSERT INTO BALANCE_PAYOUT(OPER_PAYOUT_ID,ACCT_BALANCE_ID,BILLING_CYCLE_ID,BILL_ID,OPER_TYPE,OPER_DATE,AMOUNT,BALANCE,PRN_COUNT,BALANCE_RELATION_ID,STAFF_ID,STATE,STATE_DATE)VALUES (:OPER_PAYOUT_ID,:ACCT_BALANCE_ID,:BILLING_CYCLE_ID,:BILL_ID,:OPER_TYPE,SYSDATE,:AMOUNT,:BALANCE,:PRN_COUNT,:BALANCE_RELATION_ID,:STAFF_ID,:STATE,SYSDATE)";
