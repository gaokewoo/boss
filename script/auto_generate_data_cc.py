...
def checkFileName(file_name):
    special_name = ['CERTIFICATE_TYPE','ACCT_TYPE','PRIVILEGE','STAFF_PRIVILEGE','STAFF','BILLING_REGION','REGION','ADDRESS','BILLING_CYCLE','BILLING_CYCLE_TYPE','SERV_STATE_DESC','OWE_BUSINESS_TYPE','PAYMENT_METHOD','BALANCE_SOURCE_TYPE','BALANCE_TYPE','BALANCE_STATE','ACCT_ITEM_GROUP','ACCT_ITEM_GROUP_MEMBER','ACCT_ITEM_TYPE','ACCT_ITEM_SOURCE']
