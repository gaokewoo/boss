...
string BalanceAcctItemPayed::insSQL="INSERT INTO BALANCE_ACCT_ITEM_PAYED(OPER_PAYOUT_ID,ACCT_ITEM_ID,BALANCE,SERV_ID,ACCT_ITEM_TYPE_ID,ITEM_SOURCE_ID,STATE,STATE_DATE)VALUES (:OPER_PAYOUT_ID,:ACCT_ITEM_ID,:BALANCE,:SERV_ID,:ACCT_ITEM_TYPE_ID,:ITEM_SOURCE_ID,:STATE,SYSDATE)";
